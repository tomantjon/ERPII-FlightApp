		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Demo ",
									"targetURL": "#comhogentflightdemoflightdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhogentflightdemoflightdemo-display": {
								"semanticObject": "comhogentflightdemoflightdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hogent.flightdemo.flightdemo",
									"url": sap.ui.require.toUrl("com/hogent/flightdemo/flightdemo")
								}
							}
						}
					}
